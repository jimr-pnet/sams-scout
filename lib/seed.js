...
// Consolidated search queries — 5 focused queries instead of 14.
// RSS feeds + web scrapers handle source-specific content (free).
// These queries catch breaking news, trend pieces, and broader analysis
// that no single blog covers.
const searchQueries = [
  { query: 'agentic commerce AI shopping agents latest developments this week', category: 'agentic_commerce', added_by: 'system' },
  { query: 'ChatGPT Perplexity AI product discovery shopping replacing Google', category: 'search_disruption', added_by: 'system' },
  { query: 'Google AI Overviews impact on SEO organic search traffic', category: 'search_disruption', added_by: 'system' },
  { query: 'AI disrupting digital marketing agencies client acquisition', category: 'agency_disruption', added_by: 'system' },
  { query: 'brands optimizing for AI agent recommendations digital PR opportunities', category: 'opportunities', added_by: 'system' },
];
